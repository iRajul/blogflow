...
{
    public static string $name = 'blogflow';

    public static string $viewNamespace = 'blogflow';
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('irajul/blogflow');
            });
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/blogflow/{$file->getFilename()}"),
                ], 'blogflow-stubs');
            }
        }

        // Testing
        Testable::mixin(new TestsBlogflow);
    }

    protected function getAssetPackageName(): ?string
    {
        return 'irajul/blogflow';
    }
